/*** Autogenerated by WIDL 1.9.15 from d3d10sdklayers.idl - Do not edit ***/
...
void __RPC_STUB ID3D10InfoQueue_SetBreakOnID_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D10InfoQueue_GetBreakOnCategory_Proxy(
    ID3D10InfoQueue* This,
    D3D10_MESSAGE_CATEGORY category);
void __RPC_STUB ID3D10InfoQueue_GetBreakOnCategory_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D10InfoQueue_GetBreakOnSeverity_Proxy(
    ID3D10InfoQueue* This,
    D3D10_MESSAGE_SEVERITY severity);
void __RPC_STUB ID3D10InfoQueue_GetBreakOnSeverity_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D10InfoQueue_GetBreakOnID_Proxy(
    ID3D10InfoQueue* This,
    D3D10_MESSAGE_ID id);
...
void __RPC_STUB ID3D10InfoQueue_SetMuteDebugOutput_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
BOOL STDMETHODCALLTYPE ID3D10InfoQueue_GetMuteDebugOutput_Proxy(
    ID3D10InfoQueue* This);
