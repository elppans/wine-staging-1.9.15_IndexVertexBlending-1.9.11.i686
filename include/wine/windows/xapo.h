/*** Autogenerated by WIDL 1.9.15 from xapo.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IXAPO_GetRegistrationProperties_Proxy(
    IXAPO* This,
    XAPO_REGISTRATION_PROPERTIES **props);
void __RPC_STUB IXAPO_GetRegistrationProperties_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAPO_IsInputFormatSupported_Proxy(
    IXAPO* This,
    const WAVEFORMATEX *output_fmt,
    const WAVEFORMATEX *input_fmt,
    WAVEFORMATEX **supported_fmt);
void __RPC_STUB IXAPO_IsInputFormatSupported_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAPO_IsOutputFormatSupported_Proxy(
    IXAPO* This,
    const WAVEFORMATEX *input_fmt,
    const WAVEFORMATEX *output_fmt,
    WAVEFORMATEX **supported_fmt);
void __RPC_STUB IXAPO_IsOutputFormatSupported_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAPO_Initialize_Proxy(
    IXAPO* This,
    const void *data,
    UINT32 data_len);
void __RPC_STUB IXAPO_Initialize_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAPO_Reset_Proxy(
    IXAPO* This);
void __RPC_STUB IXAPO_Reset_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IXAPO_LockForProcess_Proxy(
    IXAPO* This,
    UINT32 in_params_count,
    const XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS *in_params,
    UINT32 out_params_count,
    const XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS *out_params);
void __RPC_STUB IXAPO_LockForProcess_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IXAPO_UnlockForProcess_Proxy(
    IXAPO* This);
void __RPC_STUB IXAPO_UnlockForProcess_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IXAPO_Process_Proxy(
    IXAPO* This,
    UINT32 in_params_count,
    const XAPO_PROCESS_BUFFER_PARAMETERS *in_params,
    UINT32 out_params_count,
    const XAPO_PROCESS_BUFFER_PARAMETERS *out_params,
    BOOL enabled);
void __RPC_STUB IXAPO_Process_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
UINT32 STDMETHODCALLTYPE IXAPO_CalcInputFrames_Proxy(
    IXAPO* This,
    UINT32 output_frames);
void __RPC_STUB IXAPO_CalcInputFrames_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
UINT32 STDMETHODCALLTYPE IXAPO_CalcOutputFrames_Proxy(
    IXAPO* This,
    UINT32 input_frames);
void __RPC_STUB IXAPO_CalcOutputFrames_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
void STDMETHODCALLTYPE IXAPOParameters_SetParameters_Proxy(
    IXAPOParameters* This,
    const void *params,
    UINT32 params_len);
void __RPC_STUB IXAPOParameters_SetParameters_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
void STDMETHODCALLTYPE IXAPOParameters_GetParameters_Proxy(
    IXAPOParameters* This,
    void *params,
    UINT32 params_len);
void __RPC_STUB IXAPOParameters_GetParameters_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
