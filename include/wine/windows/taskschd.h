/*** Autogenerated by WIDL 1.9.15 from taskschd.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IDailyTrigger_get_DaysInterval_Proxy(
    IDailyTrigger* This,
    short *pDays);
void __RPC_STUB IDailyTrigger_get_DaysInterval_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDailyTrigger_put_DaysInterval_Proxy(
    IDailyTrigger* This,
    short days);
void __RPC_STUB IDailyTrigger_put_DaysInterval_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDailyTrigger_get_RandomDelay_Proxy(
    IDailyTrigger* This,
    BSTR *pRandomDelay);
void __RPC_STUB IDailyTrigger_get_RandomDelay_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE IDailyTrigger_put_RandomDelay_Proxy(
    IDailyTrigger* This,
    BSTR randomDelay);
void __RPC_STUB IDailyTrigger_put_RandomDelay_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
