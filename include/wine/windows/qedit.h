/*** Autogenerated by WIDL 1.9.15 from qedit.idl - Do not edit ***/
...
typedef struct __WIDL_qedit_generated_name_0000001C {
    BSTR name;
    DISPID dispID;
    LONG nValues;
} DEXTER_PARAM;
...
typedef enum __WIDL_qedit_generated_name_0000001E {
