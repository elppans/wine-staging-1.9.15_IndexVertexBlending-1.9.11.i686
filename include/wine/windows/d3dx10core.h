/*** Autogenerated by WIDL 1.9.15 from d3dx10core.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE ID3DX10DataLoader_Load_Proxy(
    ID3DX10DataLoader* This);
void __RPC_STUB ID3DX10DataLoader_Load_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10DataLoader_Decompress_Proxy(
    ID3DX10DataLoader* This,
    void **data,
    SIZE_T *bytes);
void __RPC_STUB ID3DX10DataLoader_Decompress_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10DataLoader_Destroy_Proxy(
    ID3DX10DataLoader* This);
void __RPC_STUB ID3DX10DataLoader_Destroy_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ID3DX10DataProcessor_Process_Proxy(
    ID3DX10DataProcessor* This,
    void *data,
    SIZE_T bytes);
void __RPC_STUB ID3DX10DataProcessor_Process_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10DataProcessor_CreateDeviceObject_Proxy(
    ID3DX10DataProcessor* This,
    void **dataobject);
void __RPC_STUB ID3DX10DataProcessor_CreateDeviceObject_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10DataProcessor_Destroy_Proxy(
    ID3DX10DataProcessor* This);
void __RPC_STUB ID3DX10DataProcessor_Destroy_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ID3DX10ThreadPump_AddWorkItem_Proxy(
    ID3DX10ThreadPump* This,
    ID3DX10DataLoader *loader,
    ID3DX10DataProcessor *processor,
    HRESULT *result,
    void **object);
void __RPC_STUB ID3DX10ThreadPump_AddWorkItem_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
UINT STDMETHODCALLTYPE ID3DX10ThreadPump_GetWorkItemCount_Proxy(
    ID3DX10ThreadPump* This);
void __RPC_STUB ID3DX10ThreadPump_GetWorkItemCount_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10ThreadPump_WaitForAllItems_Proxy(
    ID3DX10ThreadPump* This);
void __RPC_STUB ID3DX10ThreadPump_WaitForAllItems_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10ThreadPump_ProcessDeviceWorkItems_Proxy(
    ID3DX10ThreadPump* This,
    UINT count);
void __RPC_STUB ID3DX10ThreadPump_ProcessDeviceWorkItems_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10ThreadPump_PurgeAllItems_Proxy(
    ID3DX10ThreadPump* This);
void __RPC_STUB ID3DX10ThreadPump_PurgeAllItems_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT STDMETHODCALLTYPE ID3DX10ThreadPump_GetQueueStatus_Proxy(
    ID3DX10ThreadPump* This,
    UINT *queue,
    UINT *processqueue,
    UINT *devicequeue);
void __RPC_STUB ID3DX10ThreadPump_GetQueueStatus_Stub(
    IRpcStubBuffer* This,
    IRpcChannelBuffer* pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
